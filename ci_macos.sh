...
ls -lh aws-cpp-sdk/build/aws-cpp-sdk-core/
...
cp -vf ../deb_aws/aws-cpp-sdk/build/aws-cpp-sdk-transfer/*.dylib .
cp -vf ../deb_aws/aws-cpp-sdk/build/aws-cpp-sdk-s3/*.dylib .
